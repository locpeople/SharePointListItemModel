...
import { Web, sp, Item, Items } from "@pnp/sp";
...
describe("Intiation and new data", () => {
    beforeEach(function () {
        this.add = sinon.stub(Items.prototype, "add")
            .resolves({ID: 1})
...
describe("Working with existing data", () => {
    beforeEach(function () {
        ...
        this.getbyid = sinon.stub(ODataQueryable.prototype, "get")
            .resolves(this.resolveobj);
        this.update = sinon.stub(Item.prototype, "update")
            .resolves({})
    });
    afterEach(function () {
...
describe("Deleting data", () => {
    beforeEach(function () {
        ...
        this.delete = sinon.stub(Item.prototype, "delete")
            .resolves()
    });
...
describe("Lists of data", () => {
    beforeEach(function () {
        ...
        this.filter = sinon.stub(Items.prototype, "getAll")
